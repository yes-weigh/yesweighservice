...
export const SUPPORT_PHONE = '919567933252';
export const SUPPORT_TEL_HREF = `tel:+${SUPPORT_PHONE}`;
export const SUPPORT_WHATSAPP_HREF = `https://wa.me/${SUPPORT_PHONE}`;

export const LOGIN_HERO_FEATURES = [
...
export function LoginHeroFeatures() {
  return (
    <ul className="login-hero__features" aria-label="Platform highlights">
      {LOGIN_HERO_FEATURES.map(({ icon: Icon, label }, index) => (
...
export function LoginHeroTrust() {
  return (
